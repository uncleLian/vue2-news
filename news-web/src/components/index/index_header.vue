<template>
    <div id="indexHeader">
        ...
        <nav>
            <div class="nav_ul">
                <a v-for="(item,index) in navJson" :class='{active: item.type == active}' @click='active = item.type' :key="index">{{item.name}}</a>
            </div>
        </nav>
    </div>
</template>
...
[data-dpr="2"] nav a:last-child {
    margin-right: 10px;
}

[data-dpr="2"] nav a.active {
...
[data-dpr="3"] nav a:last-child {
    margin-right: 15px;
}

[data-dpr="3"] nav a.active {
